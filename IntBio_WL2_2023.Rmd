...
growth_models_fixed <- tribble(
  ...
  "3_linear_pops",            "height_next ~ parent.pop",
  "4_linear_size_pops",       "height_next ~ height.cm*parent.pop",
  "5_quadratic_size",         "height_next ~ height.cm + I(height.cm^2)", 
  "6_cubic_size",             "height_next ~ height.cm + I(height.cm^2) + I(height.cm^3)",
  "7_quadratic_size_pops",    "height_next ~ height.cm*parent.pop + I(height.cm^2)", 
  "8_cubic_size_pops",        "height_next ~ height.cm*parent.pop + I(height.cm^2) + I(height.cm^3)"
)

#run the models 
growth_models_fixed <- growth_models_fixed %>%
  mutate(lm = map(f, ~ lm(as.formula(.), data = wl2_all_2023, family = "binomial")), #run the models 
...
#cubic size with pops included seems to be the best
```
