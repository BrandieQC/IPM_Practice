...
-   Re-simulate the population with a different random seed to see if that changes the differences between the pheno vs pheno+geno IPMs

-   Would changing the heritability have an effect on diffs between IPMs?
